...
class DeleteFavoriteTvShowViewModelTest {
    ...
    fun deleteFavoriteTvShow() {
        doNothing().`when`(catalogRepository).deleteFavoriteTvShow(dataDummyTvShow)
        viewModel.deleteFavoriteTvShow(dataDummyTvShow)

        verify(catalogRepository, times(1)).deleteFavoriteTvShow(dataDummyTvShow)
    }
